#ifndef W_UI_MAP_NODE_DRAWER_H
#define W_UI_MAP_NODE_DRAWER_H
...
public:
     ...
     */
    virtual QSGNode* drawMapNode(const core::MapNode* mapNode, QSGNode* oldNode) = 0;
};

} // namespace ui
} // namespace warmonger

#endif // W_UI_MAP_NODE_DRAWER_H
