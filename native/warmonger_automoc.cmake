...
function(WARMONGER_AUTOMOC target)
    ...
    list(APPEND target_include_directories "${moc_prefix}")
    set_target_properties(${target} PROPERTIES INCLUDE_DIRECTORIES "${target_include_directories}")
    ...
    foreach(src ${target_sources})
        ...
        if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${src_header}")
            ...
            if(${qobject_pos} GREATER -1 OR ${qgadget_pos} GREATER -1)
                set(src_moc ${moc_prefix}/${src_name}.cpp)
